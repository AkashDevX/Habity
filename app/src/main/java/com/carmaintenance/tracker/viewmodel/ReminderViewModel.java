...
public class ReminderViewModel extends AndroidViewModel {
    ...
    public LiveData<List<ReminderEntity>> getRemindersForService(long serviceId) {
    ...
    public void getRemindersForService(long serviceId, OnRemindersLoadedListener listener) {
        executor.execute(() -> {
